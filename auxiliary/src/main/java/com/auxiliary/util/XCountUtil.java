...
public class XCountUtil {
     ...
     */
    public XCountUtil(Activity activity) {
     ...
     */
    public XCountUtil setSaveTime(boolean isSave) {
        this.isSave = isSave;
        return this;
    }
     ...
     * @return TimeCountUtils
     */
    public XCountUtil setTimeBeforeText(String text, @ColorInt int color) {
     ...
     * @return TimeCountUtils
     */
    public XCountUtil setTimeBeforeText(String text) {
        if (!TextUtils.isEmpty(text)) timeBeforeText = text;
        return this;
    }
     ...
     * @return TimeCountUtils
     */
    public XCountUtil setTimeAfterText(String text, @ColorInt int color) {
     ...
     * @return TimeCountUtils
     */
    public XCountUtil setTimeAfterText(String text) {
        if (!TextUtils.isEmpty(text)) timeAfterText = text;
        return this;
    }
     ...
     * @return TimeCountUtils
     */
    public XCountUtil setTimeColor(@ColorInt int color) {
     ...
     * @return TimeCountUtils
     */
    public XCountUtil setContent(String content, @ColorInt int color) {
        timeContent = content;
     ...
     * @return TimeCountUtils
     */
    public XCountUtil setTimeFormat(SimpleDateFormat isFormat) {
        format = isFormat;
        return this;
    }
     ...
     * @return TimeCountUtils
     */
    public XCountUtil setTimeAttribute(long totalTime, long duringTime) {
     ...
     * @return TimeCountUtils
     */
    public XCountUtil setTimeAttribute(long totalTime) {
        if (totalTime > 0) this.totalTime = totalTime;
        this.duringTime = 1000;
        return this;
    }
     ...
     */
    public XCountUtil initFinish(TextView textView) {
        mTextView = textView;
